  ...
  return (
    <section className='max-w-7x1 mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666E75] text-[14px] max-w-[500px]'>Create imaginative and visually stunning images through DALLY-E AI and share them with the community</p>
      </div>
      <form action="" className='mt-16 maw-w-3xl' onSubmit={handleSubmit}>
